...
Todas as referidas configurações dos recursos cloud estão disponiveis no arquivo ```serverless.yml```
...
## Neste projeto foi definido que, um usuário possui as seguintes propiedades, todas:
